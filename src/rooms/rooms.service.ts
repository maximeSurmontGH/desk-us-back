...
export class RoomsService {
  ...
  public createTaskList(roomIdDto: RoomIdDto, createTaskListDto: CreateTaskListDto) {
    return 'create a new room';
  }
  ...
  public createTask(roomId: RoomIdDto, taskListId: TaskListIdDto, createTaskDto: CreateTaskDto) {
    return 'create a new room';
  }

  public getTask(roomId: RoomIdDto, taskListId: TaskListIdDto, taskId: TaskIdDto) {
    return `task ${taskId}`;
  }

  public deleteTask(roomId: RoomIdDto, taskListId: TaskListIdDto, taskId: TaskIdDto) {
